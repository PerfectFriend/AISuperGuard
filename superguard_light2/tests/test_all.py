...
import py_compile
modules = ['superguard/__init__.py', 'superguard/main.py', 'superguard/config.py', 'superguard/models/__init__.py', 'superguard/detectors/__init__.py', 'superguard/cameras/__init__.py', 'superguard/actuators/__init__.py', 'superguard/telegram/__init__.py', 'superguard/storage/__init__.py', 'superguard/tuya_cloud/__init__.py']
