#!/usr/bin/env python3
"""
SuperGuard Alarm - Telethon Client
Uses MTProto API (no rate limits like Bot API)
Requires: API_ID, API_HASH from my.telegram.org
"""
import os
import asyncio
import json
...
# ============================================================================
# TELETHON CLIENT (MTProto - no Bot API rate limits)
# ============================================================================

class TelethonClient:
    """Telegram MTProto client with event-based updates (no polling)."""
    
    def __init__(self, config: TelegramConfig):
        self.config = config
        self.api_id = config.api_id
        self.api_hash = config.api_hash
        self.bot_token = config.token  # for sending messages if needed
...
class CommandContext:
    ...
    chat_id: int
    user_id: int
    event: Any  # Telethon event


# ============================================================================
# BOT APPLICATION (Main wiring with Telethon)
# ============================================================================

class SuperGuardTelethonBot:
    """Main bot application using Telethon (MTProto)."""
    ...
    def _load_i18n(self):
        ...
        self.L = {
            ...
            "en": {
                ...
                "lang_title": "🌐 Interface language / Idioma de la interfaz",
    ...
    async def cmd_setlocal(self, ctx: CommandContext):
        buttons = [
            [Button.inline("🇬🇧 EN", "set_lang:en"), Button.inline("🇪🇸 ES", "set_lang:es"), Button.inline("🇷🇺 RU", "set_lang:ru")]
        ]
    ...
    async def trigger_alarm(self, desc: str, frame: np.ndarray, cam_id: Optional[int] = None,
                      manual: bool = False):
    ...
    async def set_bot_menu(self):
        # Telethon doesn't use setMyCommands the same way, but we can store commands
        pass
    ...
    def write_status(self, alarm_active: bool = None):
        ...
        state = {
            ...
            "active_alarm_cameras": active_cams,
